...
class TestLibrary(unittest.TestCase):
    @staticmethod
    def build_test_records(num_of_records):
        # records = []
    ...
    def test_ok_records_single_batch(self):
        my_library = Library()
        records = self.build_test_records(5)
        result = my_library.process_records_to_batches(records)
    ...
    def test_ok_records_multi_batch(self):
        my_library = Library()
        records = self.build_test_records(505)
        result = my_library.process_records_to_batches(records)
    ...
    def test_massive_record(self):
        my_library = Library()
        records = self.build_test_records(3)
    ...
    def test_over_500_records(self):
        my_library = Library()
        records = self.build_test_records(1515)
        result = my_library.process_records_to_batches(records)
        self.assertEqual(len(result[0]), 500, "batch size incorrect")
    ...
    def test_batch_size(self):
        my_library = Library()
        records = self.build_test_records(501)
        result = my_library.process_records_to_batches(records)
        self.assertEqual(len(result[0]), 500, "batch size incorrect")
        self.assertEqual(len(result), 2, "output size incorrect")
    ...
    def test_setting_limits(self):
        ...
        records = self.build_test_records(20)
        result = my_library.process_records_to_batches(records)
